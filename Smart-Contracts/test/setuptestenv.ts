...
const giveLPTokens = async (account, lpToken, token0, token1, conversion, amount) => {
...
contract("Setup Test Env", function (accounts) {
  ...
  it("Demo", async () => {
    ...
    await giveLPTokens(testerAddress, ethDaiPair, wethToken, daiToken, conversionRates.eth.dai, 1000);
