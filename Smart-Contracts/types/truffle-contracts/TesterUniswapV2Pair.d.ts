...
export interface TesterUniswapV2PairContract
  extends Truffle.Contract<TesterUniswapV2PairInstance> {
  "new"(
    meta?: Truffle.TransactionDetails
  ): Promise<TesterUniswapV2PairInstance>;
}
...
export interface TesterUniswapV2PairInstance extends Truffle.ContractInstance {
