...
export interface UniswapOracleInstanceContract
  extends Truffle.Contract<UniswapOracleInstanceInstance> {
  "new"(
    _factory: string,
    _tokenA: string,
    _tokenB: string,
    meta?: Truffle.TransactionDetails
  ): Promise<UniswapOracleInstanceInstance>;
}
...
export interface UniswapOracleInstanceInstance
