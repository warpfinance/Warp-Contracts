...
export interface UniswapV2Router02Contract
  extends Truffle.Contract<UniswapV2Router02Instance> {
  "new"(
    _factory: string,
    _WETH: string,
    meta?: Truffle.TransactionDetails
  ): Promise<UniswapV2Router02Instance>;
}

type AllEvents = never;

export interface UniswapV2Router02Instance extends Truffle.ContractInstance {
