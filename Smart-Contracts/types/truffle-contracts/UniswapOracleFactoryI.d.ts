...
export interface UniswapOracleFactoryIContract
  extends Truffle.Contract<UniswapOracleFactoryIInstance> {
  "new"(
    meta?: Truffle.TransactionDetails
  ): Promise<UniswapOracleFactoryIInstance>;
}

type AllEvents = never;

export interface UniswapOracleFactoryIInstance
  ...
  /**
   * linkMMI is used to link a MoneyMarketInstance to its oracle in the oracle factory contract
