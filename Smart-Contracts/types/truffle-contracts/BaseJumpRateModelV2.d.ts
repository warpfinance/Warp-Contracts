...
export interface BaseJumpRateModelV2Contract
  extends Truffle.Contract<BaseJumpRateModelV2Instance> {
  "new"(
  ...
  ): Promise<BaseJumpRateModelV2Instance>;
}
...
export interface BaseJumpRateModelV2Instance extends Truffle.ContractInstance {
