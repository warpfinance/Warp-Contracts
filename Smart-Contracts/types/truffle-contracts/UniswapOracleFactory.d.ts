...
export interface UniswapOracleFactoryContract
  extends Truffle.Contract<UniswapOracleFactoryInstance> {
  "new"(
    usdcAdd: string,
    _uniFactoryAdd: string,
    meta?: Truffle.TransactionDetails
  ): Promise<UniswapOracleFactoryInstance>;
}
...
export interface UniswapOracleFactoryInstance extends Truffle.ContractInstance {
  ...
  uniswap_router_add(txDetails?: Truffle.TransactionDetails): Promise<string>;
