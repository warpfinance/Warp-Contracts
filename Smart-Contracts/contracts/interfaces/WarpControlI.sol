...
abstract contract WarpControlI {
    ...
    function addMemberToGroupSC(address _refferalCode, address _member, uint _amount) public virtual;
    function addMemberToGroupLP(address _refferalCode, address _member, address _lp, uint _amount) public virtual;
