...
export const getBlocksOfInterest = async (control: WarpControlService, scTokens: Token[], lpTokens: Token[], startBlock: ethers.providers.Block, endBlock: ethers.providers.Block): Promise<BlocksOfInterest> => {
