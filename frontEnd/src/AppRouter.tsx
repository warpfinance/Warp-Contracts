...
import { Borrower, Connect, Dashboard, Home, IntraTeamLeaderboard, Lender, Markets, TeamLeaderboard } from './pages';
import { Migrate } from './pages/App/Migrate';
import { CalculateMetrics } from './pages/CalculateMetrics';
import { MigrationRequired } from './pages/MigrationRequired';
                ...
                <Switch>
                    ...
                    <React.Fragment>
                        <Route
                            ...
                            render={() => (
                                <Web3AccountRequired>
                                    <MigrationRequired page={<Borrower />} />
                                </Web3AccountRequired>
                            )}
                        />
                        <Route
                        ...
                        <Route
                            ...
                            render={() => (
                                <Web3AccountRequired>
                                    <MigrationRequired page={<TeamLeaderboard />} />
                                </Web3AccountRequired>
                            )}
                        />
                        <Route
                            ...
                            render={() => (
                                <Web3AccountRequired>
                                    <MigrationRequired page={<IntraTeamLeaderboard />} />
                                </Web3AccountRequired>
                            )}
                        />
                    </React.Fragment>
