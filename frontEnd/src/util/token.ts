...
const tokenImages: {[key: string]: string | string[]} = {
  ...
  '0xa478c2975ab1ea89e8196811f51a7b7ade33eb11': ['eth.png', 'dai.ping'],
  '0x0d4a11d5eeaac28ec3f61d100daf4d40471f1852': ['eth.png', 'usdt.ping'],
  '0xb4e16d0168e52d35cacd2c6185b44281ec28c9dc': ['eth.png', 'usdc.ping'],
  '0xbb2b8038a1640196fbe3e38816f3e67cba72d940': ['eth.png', 'wbtc.ping'],
